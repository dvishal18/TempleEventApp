...
import com.appproj.vd.shyambaba.helper.ListViewAdapter;
...
public class DisplayData extends AppCompatActivity {
    ...
    String BASE_URL = "https://datasyninfo.000webhostapp.com/details";
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // textView = (TextView)findViewById(R.id.tvDetails);
        //textView.setText(details_list.getCount());

        String ename,place,date,time;
                             ...
                             try {
                                 ...
                                 if (success == 1) {
                                     ...
                                     for (int i = 0; i < jsonArray.length(); i++) {
                                         ...
                                         id.add(0,jo.getString("id"));
                                         name.add(0,jo.getString("name"));
                                         age.add(0,jo.getString("age"));
                                         mobile.add(0,jo.getString("mobile"));
                                         email.add(0,jo.getString("email"));
