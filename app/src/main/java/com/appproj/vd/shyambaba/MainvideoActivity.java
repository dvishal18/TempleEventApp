...
public class MainvideoActivity extends AppCompatActivity {
   ...
   String TAG="MainvideoActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customListAdapter=new CustomListAdapter(MainvideoActivity.this,videoDetailsArrayList);
    ...
    private void showVideo() {
        ...
        String URL="https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q="+searchName+"&key=AIzaSyBvAPKuAIu9OCixY25YHW2Oq8C31DVWXdE";
